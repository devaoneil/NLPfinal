# code adapted from https://github.com/allenai/cartography/
# based on paper Dataset Cartography: Mapping and Diagnosing Datasets...
...
def plot_data_map(dataframe: pd.DataFrame,
                  ...
                  title: str = 'Adversarial',
                  model: str = 'ELECTRA-small',
                  show_hist: bool = False,
                  max_instances_to_plot = 10000):
    # Set style.
    sns.set(style='whitegrid', font_scale=1.6, font='Georgia', context='paper')
    logger.info(f"{title} using {model} model ...")
    ...
    fig.tight_layout()
    filename = f'{plot_dir}/{title}.pdf' if show_hist else f'figures/compact_{title}.pdf'
